...
def get_parser():
  arguement = argparse.ArgumentParser("this is 3D PCA")
  arguement.add_argument("--filename", type=str, default="../modelnet40_normal_resampled/airplane/airplane_0001.txt", help="the path of pointcloud")
  arguement.add_argument("--number_nearest", type=int, default=50, help="the number of nearest points")
  return arguement.parse_args()
...
if __name__ == '__main__':
  ...
  number_nearest = parser.number_nearest   # 邻域数量
